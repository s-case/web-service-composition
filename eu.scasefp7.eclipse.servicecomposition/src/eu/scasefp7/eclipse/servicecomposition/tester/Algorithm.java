...
//			codeGenerated = (new eu.scasefp7.eclipse.servicecomposition.codeGenerator.LinearCodeGenerator()).generateCode(
//					graph, "tester", true);
//		} catch (Exception e) {
//			System.out.print("Failed\nGenerating class code... ");
//			codeGenerated = (new eu.scasefp7.eclipse.servicecomposition.codeGenerator.NonLinearCodeGenerator()).generateCode(
//					graph, "tester", true);
//		}
