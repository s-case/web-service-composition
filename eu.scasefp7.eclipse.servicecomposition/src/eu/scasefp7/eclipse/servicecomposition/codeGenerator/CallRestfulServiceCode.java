...
public class CallRestfulServiceCode {
	...
	public static String generateCode(String packageName) {
		...
		// code += TAB + TAB + TAB + TAB + "}\n";
		// code += TAB + TAB + TAB + TAB + "post.setEntity(new
		...
		// BasicNameValuePair(input.name, input.value));\n";
		// code += TAB + TAB + TAB + TAB + "}\n";
		// code += TAB + TAB + TAB + TAB + "put.setEntity(new
		// UrlEncodedFormEntity(urlParameters));\n";
		...
		code += TAB + "}\n";
		// code += TAB + "public static void assignResult(JSONObject json,
		// Variable output){\n";
		// code += TAB + TAB + "if (output.type.equals(\"object\")) {\n";
		// code += TAB + TAB + TAB + "if (((JSONObject)
		// json).containsKey(output.name)) {\n";
		// code += TAB + TAB + TAB + TAB+ "JSONObject object = (JSONObject)
		// ((JSONObject) json).get(output.name);\n";
		// code += TAB + TAB + TAB + TAB+ "for (Variable sub : output.subtypes)
		// {\n";
		// code += TAB + TAB + TAB + TAB + TAB+ "assignResult((JSONObject)
		// object, sub);\n";
		// code += TAB + TAB + TAB + TAB+ "}\n"+ TAB + TAB + TAB +"}\n";
		// code += TAB + TAB + "} else if
		// (output.type.equals(\"arrayOfObjects\")) {\n";
		// code += TAB + TAB + TAB + "JSONArray array = (JSONArray)
		// ((JSONObject) json).get(output.name);\n";
		// code += TAB + TAB + TAB + "boolean subisarray = false;\n";
		// code += TAB + TAB + TAB + "for (Variable sub : output.subtypes) {\n";
		// code += TAB + TAB + TAB + TAB + "if
		// (sub.type.equals(\"arrayOfObjects\") || sub.type.equals(\"array\"))
		// {\n";
		// code += TAB + TAB + TAB + TAB + TAB + "subisarray = true;\n";
		// code += TAB + TAB + TAB + TAB + "}\n" + TAB + TAB + TAB + "}\n";
		// code += TAB + TAB + TAB + "if (subisarray) {\n";
		// code += TAB + TAB + TAB + TAB + "for (int i = 0; i < array.size();
		// i++) {\n";
		// code += TAB + TAB + TAB + TAB + TAB + "for (Variable sub :
		// output.subtypes) {\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "Variable out= new
		// Variable(sub);\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB +
		// "assignResult((JSONObject) array.get(i), out);\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "out.name=output.name +
		// \"[\" + i + \"]\";\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB +
		// "output.arrayElements.add(out);\n";
		// code += TAB + TAB + TAB + TAB + TAB + "}\n" + TAB + TAB + TAB + TAB +
		// "}\n";
		// code += TAB + TAB + TAB + "} else {\n";
		// code += TAB + TAB + TAB + TAB + "if (array != null) {\n";
		// code += TAB + TAB + TAB + TAB + TAB + "for (int i = 0; i <
		// array.size(); i++) {\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "Variable out = new
		// Variable(output);\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "out.name = output.name +
		// \"[\" + i + \"]\";\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "out.type=
		// \"object\";\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "JSONObject object =
		// (JSONObject) array.get(i);\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "for (Variable sub :
		// out.subtypes) {\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + TAB +
		// "assignResult(object, sub);\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "}\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB +
		// "output.arrayElements.add(out);\n";
		// code += TAB + TAB + TAB + TAB + TAB + "}\n" + TAB + TAB + TAB + TAB +
		...
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "out = new
		// Variable(output.name + \"[\" + i + \"]\", \"\", \"String\");\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "out.value =
		// array.get(i).toString();\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB +
		// "output.arrayElements.add(out);\n";
		// code += TAB + TAB + TAB + TAB + TAB + "} catch (Exception e) {\n";
		// code += TAB + TAB + TAB + TAB + TAB + TAB + "// TODO Auto-generated
		// catch block\n";
